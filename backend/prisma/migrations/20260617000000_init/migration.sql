...
-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('USER_CREATED', 'USER_UPDATED', 'USER_PERMISSION_UPDATED', 'USER_BANNED', 'USER_UNBANNED', 'MESSAGE_EDITED', 'MESSAGE_DELETED', 'CONVERSATION_CREATED');
...
-- CreateIndex
CREATE UNIQUE INDEX "NotificationSubscription_userId_provider_endpoint_key" ON "NotificationSubscription"("userId", "provider", "endpoint");
